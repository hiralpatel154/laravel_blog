            ...
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-8 col-md-10">
                    <div class="breadcrumb__wrap__content">
                        <h2 class="title">{{$blogsdetail->blog_title}}</h2>
                ...
                <div class="col-lg-8">
                    <div class="standard__blog__post">
                        <div class="standard__blog__thumb">
                            <img src="{{asset($blogsdetail->blog_image)}}" alt="">
                        </div>
                        <div class="blog__details__content services__details__content">
                            <ul class="blog__post__meta">
                                <li><i class="fal fa-calendar-alt"></i> {{Carbon\Carbon::parse($blogsdetail->created_at)->diffForHumans()}}</li>
                                <!-- <li><i class="fal fa-comments-alt"></i> <a href="#">Comment (08)</a></li> -->
                                <!-- <li class="post-share"><a href="#"><i class="fal fa-share-all"></i> (18)</a></li> -->
                            </ul>
                            <h2 class="title">{{$blogsdetail->blog_title}}</h2>
                            <p>{!! $blogsdetail->blog_description !!}</p>
                        </div>
                        <div class="blog__details__bottom">
                            <ul class="blog__details__tag">
                                <li class="title">Tag:</li>
                                <li class="tags-list">
                                    <a href="#">{{$blogsdetail->blog_tags}} </a>
                                </li>
                            </ul>
                        ...
                        <!-- <div class="widget">
                            ...
                            <ul class="sidebar__comment">
                                <li class="sidebar__comment__item">
                                    <a href="blog-details.html">Skills Sponde</a>
