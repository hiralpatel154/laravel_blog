@php
$aboutpageVar = App\Models\About::find(1);
@endphp
<section id="aboutSection" class="about">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6">
            <img src="{{$aboutpageVar->about_image}}" alt="">
            ...
            <div class="col-lg-6">
                <div class="about__content">
                    <div class="section__title">
                        ...
                        <h2 class="title">{{$aboutpageVar->title}}</h2>
                    </div>
                    <div class="about__exp">
                        ...
                        <div class="about__exp__content">
                            <p>{{$aboutpageVar->short_title}}</p>
                        </div>
                    </div>
                    <p class="desc">{{$aboutpageVar->short_desc}}</p>
                    <a href="{{asset('frontend/assets/Hiral Resume PHP Laravel Updated.pdf')}}" class="btn" target="_blank">Download my resume</a>
                </div>
            </div>
        </div>
    </div>
